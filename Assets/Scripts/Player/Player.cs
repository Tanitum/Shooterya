...
public class Player : NetworkBehaviour
{
    ...
    [SerializeField] private AudioClip _damageSound, _jumpSound;
    ...
    private bool JumpingThisFrame { get; set; }
    private bool LandingThisFrame { get; set; }
    private Vector3 RawMovement { get; set; }
    private bool Grounded => _colDown;
    ...
    {
        Health.OnValueChanged += (int previousValue, int newValue) => { if (newValue <= 0) Death(); };
    }
    ...
    private void Awake()
    {
        ...
        bar = GameObject.FindGameObjectWithTag("Health Bar").GetComponent<Image>();
    ...
    public void GetDamage()
    {
        ...
        bar.fillAmount = Health.Value / startHealth;
    }
